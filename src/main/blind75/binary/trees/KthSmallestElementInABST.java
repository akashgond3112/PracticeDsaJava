...
/**
 * 230. Kth Smallest Element in a BST Medium Topics Companies Hint Given the root of a binary search tree, and an
 * integer k, return the kth smallest value (1-indexed) of all the values of the nodes in the tree.
 * <p>
 *
 *
 * Example 1:
