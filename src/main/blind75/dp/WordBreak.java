...
public class WordBreak {
	 ...
	 * words in wordDict and t is the maximum length of any word in w o r d D i c t wordDict.
	 */
	...
	/**
	 * Time complexity: O((n∗2^n )+m) Space complexity: O(n+(m∗t)) Where n n is the length of the string s s and m m is
	 ...
	 * , m is the number of words in w o r d D i c t wordDict and t is the maximum length of any word in w o r d D
	 * i c t wordDict.
	 */
