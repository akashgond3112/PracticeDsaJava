...
/*
    ...
    You are given a string answerKey, where answerKey[startIndex] is the original answer to the ith question.
    In addition, you are given an integer k, the maximum number of times you may perform the following operation:

    Change the answer key for any question to 'T' or 'F' (startIndex.e., set answerKey[startIndex] to 'T' or 'F').
    ...
    n == answerKey.length
    1 <= n <= 5 * 104
    answerKey[startIndex] is either 'T' or 'F'
    1 <= k <= n
*/
public class MaximizeTheConfusionOfAnExam {
    ...
    public static void main(String[] args) {
        String string = "TTFTTFTT";
        int k = 1;
        System.out.println(maxConsecutiveAnswers(string, k));
    }
}
