...
/**
 * Problem Statement: Given two arrays of non-negative integers. FInd the maximum possible value of A XOR B where A and
 * B are elements from the arr1 and arr2 array respectively and XOR represents the Bitwise XOR operation.
 *
 * Examples Example 1: Input:Arr1: 3 10 5 25 2, Arr2: 8 1 2 12 7 Output: Maximum XOR value: 30 Explanation: The maximum
 * XOR value is 30, which occurs when XORing 7 and 25. Example 2: Input:Arr1:  9, 8, 7, 5, 4, Arr2: 12, 44, 22, 10
 * Output: Maximum XOR value: 43 Explanation: The maximum XOR value is 43, which occurs when XORing 44 and 7.
 */
